...
namespace Buma.Administracion.servicios.Interfaces
{
    ...
    {
        public Task<List<Licencia>> GetLicenciaListAsync();

        public Task<Licencia> GetLicenciaByIdAsync(int idLicencia);
        public Task InsertLicencia(Licencia licencia);
        public Task UpdateLicencia(Licencia licencia);
    }
}
