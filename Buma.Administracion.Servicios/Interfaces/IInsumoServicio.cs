...
namespace Buma.Administracion.servicios.Interfaces
{
    ...
    {
        public Task<List<Insumo>> GetInsumoListAsync();

        public Task<Insumo> GetInsumoByIdAsync(int idInsumo);
        public Task InsertInsumo(Insumo insumo);
        public Task UpdateInsumo(Insumo insumo);
    }
}
