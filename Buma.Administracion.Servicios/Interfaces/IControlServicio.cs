...
namespace Buma.Administracion.servicios.Interfaces
{
    ...
    {
        public Task<List<Control>> GetControlListAsync();

        public Task<Control> GetControlByIdAsync(int idControl);
        public Task InsertControl(Control control);
        public Task UpdateControl(Control control);
    }
}
